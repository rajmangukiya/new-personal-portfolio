    ...
    return (
        <div className="bg-dark">
            <div className="container d-flex justify-content-center">
                <ul className="d-flex align-items-center my-3 p-0 justify-content-evenly footer-ul">
                    <a target="_blank" href="https://www.instagram.com/raj__mangukiya/">
                    ...
                    <a target="_blank" href="https://twitter.com/RajMangukiya12">
                    ...
                    <a target="_blank" href="https://www.linkedin.com/in/raj-mangukiya-6335431b4/">
                    ...
                    <a target="_blank" href="https://www.facebook.com/raj.mangukiya.967">
